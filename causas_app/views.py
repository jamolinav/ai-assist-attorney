...
from .models import Competencia, Corte, Tribunal, TipoCausa
from django.views.decorators.http import require_GET
from django.views.decorators.http import require_POST
from causas_app.models import Causa  # ajusta el modelo real
import logging
...
def procesar_causa(request):
    ...
    tipo_causa = TipoCausa.objects.get(id=conTipoCausa).nombre if conTipoCausa else "C"
...
def get_tipos_por_competencia(request, competencia_id=None):
    ...
    tipos = list(TipoCausa.objects.filter(competencia_id=competencia_id).values("id", "nombre"))
